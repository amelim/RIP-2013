...
evaluation.
    ...
    % DATA
    % ########################################################
    Problem 2.1 [time] 		&  0.0 	& 0.27 	& 0 \\ \hline    
    Problem 2.2 [time] 		&  0.0	& - 	& 0 \\ \hline
    Problem 2.3 [time] 		&  0.02 & - 	& 0 \\ \hline
    Problem Challenge [time] 	&  0.7 	& - 	& 0 \\ \hline\hline
    Problem 2.1 [steps]		&  12 	& 14 	& 0 \\ \hline
    Problem 2.2 [steps]		&  31 	& 0 	& 0 \\ \hline
    Problem 2.3 [steps]		&  110 	& 0 	& 0 \\ \hline
    Problem Challenge [steps]	&  77 	& 0 	& 0 \\ \hline
    % ########################################################
    \hline
    \end{tabular*}
    \end{table}
