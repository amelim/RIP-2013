 ...
 *
 *
 *  $Id: adns.h,v 1.1.1.1 2000/06/12 16:37:46 jgaa Exp $
 */
...
ADNS_API int adns_processreadable(adns_state ads, int fd, const struct timeval *now);
ADNS_API int adns_processwriteable(adns_state ads, int fd, const struct timeval *now);
ADNS_API int adns_processexceptional(adns_state ads, int fd, const struct timeval *now);
