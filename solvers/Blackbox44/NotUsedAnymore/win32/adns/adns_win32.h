...
#ifdef ADNS_MAP_POLLAPI
#  define poll(ufds, nfds, timeout) adns_poll(ufds, nfds, timeout)

ADNS_API int adns_poll(struct pollfd *ufds, unsigned int nfds, int timeout);
#define HAVE_POLL 1
#endif /* HAVE_POLL */
